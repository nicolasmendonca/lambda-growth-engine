      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-gray-700 mb-10 max-w-2xl mx-auto">
            We help online-first businesses streamline operations and eliminate
            bottlenecks using AI-powered automations—built and maintained for
            growth.
          </p>
          <a
            ...
            className={cn(
              buttonVariants({
                ...
                size: "lg",
                className:
                  "bg-gradient-to-r from-lambda-blue to-lambda-purple hover:opacity-90 transition-opacity text-lg flex items-center gap-2 px-6 py-6 w-fit mx-auto",
              })
            )}
          >
        ...
        <div className="mt-16 md:mt-20 max-w-5xl mx-auto">
          <div className="relative w-full h-64 md:h-80 lg:h-96 bg-gradient-to-br from-lambda-blue/10 to-lambda-purple/10 rounded-xl overflow-hidden flex items-center justify-center">
            ...
            <div
              className="absolute top-1/3 left-1/4 animate-float opacity-25"
